  <div class="box2">
                      ...
                      if($type == 0){
                        ...
                        <a class="myreact_{{$row->post->id}}" href="javascript:void(0)" post_id="{{$row->id}}"><img style="height: 26px;margin: 0 !important;" src="/image/{{$image}}" alt=""/><span>{{count($row->post->reacts)}}</span></a>

                      <?php }else{?>
                        <a class="myreact_{{$row->post->id}}" href="javascript:void(0)" post_id="{{$row->id}}"><i class="far fa-thumbs-up" style="font-size: 19px!important;"></i><span>{{count($row->post->reacts)}}</span></a>
