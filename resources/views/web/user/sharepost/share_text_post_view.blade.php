 <div class="box4">
                              ...
                              <div class="sandy">
                                  <div class="sandy-row">
                                      <div class="sandy-left">
                                         ...
                                         <p>{{$row->text}}</p>
                                  <p id="append_result_{{$row->post->id}}">{{$row->post->post_title}}</p>
                                      </div>
                      ...
                      <?php }?>
                          ...
                          <div class="hover-emoji-option">
                            ...
                            <a class="react" href="javascript:void(0)" post_id="{{$row->post->id}}" type="3"><img src="/image/face_with_tears_of_joy" alt=""/></a>
                          </div>
                      </li>
