                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @if(count($data['records'])>0)
                    ...
                    <tr>
                      ...
                      <a class="btn btn-app" href="{{route('delete-post',[$row->id])}}" onclick="return confirm('Are you sure you want to delete ?');" title ="Delete">
                        <i class="fas fa-trash"></i> Delete
                      </a>
                     

                       <a class="btn btn-app" href="{{route('change_post_status',[$row->id])}}"  title ="{{ $row->status==1 ? 'Deactivate' : 'Activate'}}">
